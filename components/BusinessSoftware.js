      ...
      <div className={styles.grid}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.chat}>
            <span className={styles.green}>Happy birthday! Here's an exclusive promo just for you 💛</span>
            <span className={styles.white}>Thank you 🥰</span>
          </div>
        </div>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.payment}>
            <p>Your payment of <strong>$42</strong> is pending. Complete your payment at <a href="#">balidining.me/pay</a></p>
          </div>
        </div>
